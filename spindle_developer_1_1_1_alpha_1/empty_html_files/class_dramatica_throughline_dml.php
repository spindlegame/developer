...
// Data functions (insert, update, delete, form) for table class_dramatica_throughline
...
function class_dramatica_throughline_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		$jsReadOnly .= "\tjQuery('#throughline').replaceWith('<div class=\"form-control-static\" id=\"throughline\">' + (jQuery('#throughline').val() || '') + '</div>');\n";
