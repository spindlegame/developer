...
// Data functions (insert, update, delete, form) for table class_rights
...
function class_rights_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		$jsReadOnly .= "\tjQuery('#right').replaceWith('<div class=\"form-control-static\" id=\"right\">' + (jQuery('#right').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#certification').replaceWith('<div class=\"form-control-static\" id=\"certification\">' + (jQuery('#certification').val() || '') + '</div>');\n";
