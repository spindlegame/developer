...
function biblio_author_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_agenttype1->HTML = '<span id="agenttype1-container' . $rnd1 . '"></span><input type="hidden" name="agenttype1" id="agenttype1' . $rnd1 . '" value="' . htmlspecialchars($combo_agenttype1->SelectedData) . '">';
	$combo_agenttype1->MatchText = '<span id="agenttype1-container-readonly' . $rnd1 . '"></span><input type="hidden" name="agenttype1" id="agenttype1' . $rnd1 . '" value="' . htmlspecialchars($combo_agenttype1->SelectedData) . '">';
	$combo_agenttype2->HTML = '<span id="agenttype2-container' . $rnd1 . '"></span><input type="hidden" name="agenttype2" id="agenttype2' . $rnd1 . '" value="' . htmlspecialchars($combo_agenttype2->SelectedData) . '">';
	$combo_agenttype2->MatchText = '<span id="agenttype2-container-readonly' . $rnd1 . '"></span><input type="hidden" name="agenttype2" id="agenttype2' . $rnd1 . '" value="' . htmlspecialchars($combo_agenttype2->SelectedData) . '">';
	$combo_gender->Render();
	...
	if(($selected_id && !$AllowUpdate) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#selection_class').replaceWith('<div class=\"form-control-static\" id=\"selection_class\">' + (jQuery('#selection_class').val() || '') + '</div>');\n";
		...
		$jsReadOnly .= "\tjQuery('#birthday').replaceWith('<div class=\"form-control-static\" id=\"birthday\">' + (jQuery('#birthday').val() || '') + '</div>');\n";
		...
		$jsReadOnly .= "\tjQuery('#deathday').replaceWith('<div class=\"form-control-static\" id=\"deathday\">' + (jQuery('#deathday').val() || '') + '</div>');\n";
	...
	$parent_tables = array(  'class_agent_type1' => array('agenttype1', 'Agent category'), 'class_agent_type2' => array('agenttype2', 'Agent group'), 'class_authority_agent' => array('authority_organization', 'Authority organization'));
	...
	$templateCode=str_replace('<%%UPLOADFILE(img)%%>', ($noUploads ? '' : '<input type=hidden name=MAX_FILE_SIZE value=921600>'.$Translation['upload image'].' <input type="file" name="img" id="img">'), $templateCode);
