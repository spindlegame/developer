...
function storypoints_static_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_throughline->HTML = '<span id="throughline-container' . $rnd1 . '"></span><input type="hidden" name="throughline" id="throughline' . $rnd1 . '" value="' . htmlspecialchars($combo_throughline->SelectedData) . '">';
	$combo_throughline->MatchText = '<span id="throughline-container-readonly' . $rnd1 . '"></span><input type="hidden" name="throughline" id="throughline' . $rnd1 . '" value="' . htmlspecialchars($combo_throughline->SelectedData) . '">';
	$combo_throughline_domain->HTML = '<span id="throughline_domain-container' . $rnd1 . '"></span><input type="hidden" name="throughline_domain" id="throughline_domain' . $rnd1 . '" value="' . htmlspecialchars($combo_throughline_domain->SelectedData) . '">';
	$combo_throughline_domain->MatchText = '<span id="throughline_domain-container-readonly' . $rnd1 . '"></span><input type="hidden" name="throughline_domain" id="throughline_domain' . $rnd1 . '" value="' . htmlspecialchars($combo_throughline_domain->SelectedData) . '">';
	$combo_concern->HTML = '<span id="concern-container' . $rnd1 . '"></span><input type="hidden" name="concern" id="concern' . $rnd1 . '" value="' . htmlspecialchars($combo_concern->SelectedData) . '">';
	$combo_concern->MatchText = '<span id="concern-container-readonly' . $rnd1 . '"></span><input type="hidden" name="concern" id="concern' . $rnd1 . '" value="' . htmlspecialchars($combo_concern->SelectedData) . '">';
	$combo_issue->HTML = '<span id="issue-container' . $rnd1 . '"></span><input type="hidden" name="issue" id="issue' . $rnd1 . '" value="' . htmlspecialchars($combo_issue->SelectedData) . '">';
	$combo_issue->MatchText = '<span id="issue-container-readonly' . $rnd1 . '"></span><input type="hidden" name="issue" id="issue' . $rnd1 . '" value="' . htmlspecialchars($combo_issue->SelectedData) . '">';
	$combo_problem->HTML = '<span id="problem-container' . $rnd1 . '"></span><input type="hidden" name="problem" id="problem' . $rnd1 . '" value="' . htmlspecialchars($combo_problem->SelectedData) . '">';
	$combo_problem->MatchText = '<span id="problem-container-readonly' . $rnd1 . '"></span><input type="hidden" name="problem" id="problem' . $rnd1 . '" value="' . htmlspecialchars($combo_problem->SelectedData) . '">';
	$combo_solution->HTML = '<span id="solution-container' . $rnd1 . '"></span><input type="hidden" name="solution" id="solution' . $rnd1 . '" value="' . htmlspecialchars($combo_solution->SelectedData) . '">';
	$combo_solution->MatchText = '<span id="solution-container-readonly' . $rnd1 . '"></span><input type="hidden" name="solution" id="solution' . $rnd1 . '" value="' . htmlspecialchars($combo_solution->SelectedData) . '">';
	$combo_symptom->HTML = '<span id="symptom-container' . $rnd1 . '"></span><input type="hidden" name="symptom" id="symptom' . $rnd1 . '" value="' . htmlspecialchars($combo_symptom->SelectedData) . '">';
	$combo_symptom->MatchText = '<span id="symptom-container-readonly' . $rnd1 . '"></span><input type="hidden" name="symptom" id="symptom' . $rnd1 . '" value="' . htmlspecialchars($combo_symptom->SelectedData) . '">';
	$combo_response->HTML = '<span id="response-container' . $rnd1 . '"></span><input type="hidden" name="response" id="response' . $rnd1 . '" value="' . htmlspecialchars($combo_response->SelectedData) . '">';
	$combo_response->MatchText = '<span id="response-container-readonly' . $rnd1 . '"></span><input type="hidden" name="response" id="response' . $rnd1 . '" value="' . htmlspecialchars($combo_response->SelectedData) . '">';
	$combo_catalyst->HTML = '<span id="catalyst-container' . $rnd1 . '"></span><input type="hidden" name="catalyst" id="catalyst' . $rnd1 . '" value="' . htmlspecialchars($combo_catalyst->SelectedData) . '">';
	$combo_catalyst->MatchText = '<span id="catalyst-container-readonly' . $rnd1 . '"></span><input type="hidden" name="catalyst" id="catalyst' . $rnd1 . '" value="' . htmlspecialchars($combo_catalyst->SelectedData) . '">';
	$combo_inhibitor->HTML = '<span id="inhibitor-container' . $rnd1 . '"></span><input type="hidden" name="inhibitor" id="inhibitor' . $rnd1 . '" value="' . htmlspecialchars($combo_inhibitor->SelectedData) . '">';
	$combo_inhibitor->MatchText = '<span id="inhibitor-container-readonly' . $rnd1 . '"></span><input type="hidden" name="inhibitor" id="inhibitor' . $rnd1 . '" value="' . htmlspecialchars($combo_inhibitor->SelectedData) . '">';
	$combo_benchmark->HTML = '<span id="benchmark-container' . $rnd1 . '"></span><input type="hidden" name="benchmark" id="benchmark' . $rnd1 . '" value="' . htmlspecialchars($combo_benchmark->SelectedData) . '">';
	$combo_benchmark->MatchText = '<span id="benchmark-container-readonly' . $rnd1 . '"></span><input type="hidden" name="benchmark" id="benchmark' . $rnd1 . '" value="' . htmlspecialchars($combo_benchmark->SelectedData) . '">';
	...
	<script>
		...
		jQuery(function() {
			...
			if(typeof(problem_reload__RAND__) == 'function') problem_reload__RAND__();
			if(typeof(solution_reload__RAND__) == 'function') solution_reload__RAND__();
			if(typeof(symptom_reload__RAND__) == 'function') symptom_reload__RAND__();
			if(typeof(response_reload__RAND__) == 'function') response_reload__RAND__();
		...
		function problem_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			jQuery("#problem-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'storypoints_static', f: 'problem' }; },
					results: function(resp, page){ return resp; }
				}
			}).on('change', function(e){
		...
		function solution_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			jQuery("#solution-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'storypoints_static', f: 'solution' }; },
					results: function(resp, page){ return resp; }
				}
			}).on('change', function(e){
		...
		function symptom_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			jQuery("#symptom-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'storypoints_static', f: 'symptom' }; },
					results: function(resp, page){ return resp; }
				}
			}).on('change', function(e){
		...
		function response_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			jQuery("#response-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'storypoints_static', f: 'response' }; },
					results: function(resp, page){ return resp; }
				}
			}).on('change', function(e){
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			jQuery("#catalyst-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p: page, t: 'storypoints_static', f: 'catalyst' }; },
					results: function(resp, page){ return resp; }
				}
			}).on('change', function(e){
	...
	$parent_tables = array(  'story' => array('story', 'Story'), 'class_dramatica_throughline' => array('throughline', 'Throughline'), 'class_dramatica_domain' => array('throughline_domain', 'Domain'), 'class_dramatica_concern' => array('concern', 'Concern'), 'class_dramatica_issue' => array('issue', 'Issue'), 'class_dramatica_themes' => array('problem', 'Problem'), 'class_dramatica_themes' => array('solution', 'Solution'), 'class_dramatica_themes' => array('symptom', 'Symptom'), 'class_dramatica_themes' => array('response', 'Response'), 'class_dramatica_issue' => array('catalyst', 'Catalyst/ Approach'), 'class_dramatica_issue' => array('inhibitor', 'Inhibitor/ Delay'), 'class_dramatica_concern' => array('benchmark', 'Benchmark'));
