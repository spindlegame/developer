...
if(function_exists('date_default_timezone_set')) @date_default_timezone_set('Europe/Madrid');
...
function NavMenus($options = array()){
	...
	if(is_array($arrTables)){
		foreach($arrTables as $tn => $tc){
			...
			$tChkHL = array_search($tn, array('class_agent_type1','class_agent_type2','class_authority_agent','class_authority_library','class_bibliography_genre','class_bibliography_type','class_bibliography_archive','class_dramatica_archetype','class_dramatica_domain','class_dramatica_concern','class_dramatica_issue','class_dramatica_themes','class_dramatica_throughline','class_im','class_language','class_nt','class_character_element','class_rights'));
...
function StyleSheet(){
	$css_links  = '<link rel="stylesheet" href="resources/initializr/css/smcu4.css">';
