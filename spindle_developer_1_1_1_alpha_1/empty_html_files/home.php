	...
	<?php
		...
		if(is_array($arrTables) && count($arrTables)){
			...
			foreach($arrTables as $tn=>$tc){
				...
				$tChkHL = array_search($tn, array('code_encounter_scenes','storyboard','dictionary','class_agent_type1','class_agent_type2','class_authority_agent','class_authority_library','class_bibliography_genre','class_bibliography_type','class_bibliography_archive','class_dramatica_archetype','class_dramatica_domain','class_dramatica_concern','class_dramatica_issue','class_dramatica_themes','class_dramatica_throughline','class_im','class_language','class_nt','class_character_element','class_rights'));
