...
function story_insert(){
	...
	$data['synopsis_backstory'] = br2nl(makeSafe($_POST['synopsis_backstory']));
	...
	sql('insert into `story` set       `subject`=' . (($data['subject'] !== '' && $data['subject'] !== NULL) ? "'{$data['subject']}'" : 'NULL') . ', `story`=' . (($data['story'] !== '' && $data['story'] !== NULL) ? "'{$data['story']}'" : 'NULL') . ', `tags`=' . (($data['tags'] !== '' && $data['tags'] !== NULL) ? "'{$data['tags']}'" : 'NULL') . ', `collaboration_status`=' . (($data['collaboration_status'] !== '' && $data['collaboration_status'] !== NULL) ? "'{$data['collaboration_status']}'" : 'NULL') . ', `synopsis_backstory`=' . (($data['synopsis_backstory'] !== '' && $data['synopsis_backstory'] !== NULL) ? "'{$data['synopsis_backstory']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function story_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `story` set       `subject`=' . (($data['subject'] !== '' && $data['subject'] !== NULL) ? "'{$data['subject']}'" : 'NULL') . ', `story`=' . (($data['story'] !== '' && $data['story'] !== NULL) ? "'{$data['story']}'" : 'NULL') . ', `tags`=' . (($data['tags'] !== '' && $data['tags'] !== NULL) ? "'{$data['tags']}'" : 'NULL') . ', `collaboration_status`=' . (($data['collaboration_status'] !== '' && $data['collaboration_status'] !== NULL) ? "'{$data['collaboration_status']}'" : 'NULL') . ', `synopsis_backstory`=' . (($data['synopsis_backstory'] !== '' && $data['synopsis_backstory'] !== NULL) ? "'{$data['synopsis_backstory']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function story_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('input[name=collaboration_status]').parent().html('<div class=\"form-control-static\">' + jQuery('input[name=collaboration_status]:checked').next().text() + '</div>')\n";
		$jsReadOnly .= "\tjQuery('#synopsis_backstory').replaceWith('<div class=\"form-control-static\" id=\"synopsis_backstory\">' + (jQuery('#synopsis_backstory').val() || '') + '</div>');\n";
	...
	$templateCode=str_replace('<%%UPLOADFILE(synopsis_backstory)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(synopsis_backstory)%%>', nl2br(htmlspecialchars($row['synopsis_backstory'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(synopsis_backstory)%%>', htmlspecialchars($row['synopsis_backstory'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(synopsis_backstory)%%>', urlencode($urow['synopsis_backstory']), $templateCode);
	}else{
		...
		$templateCode=str_replace('<%%VALUE(synopsis_backstory)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(synopsis_backstory)%%>', urlencode(''), $templateCode);
	}
