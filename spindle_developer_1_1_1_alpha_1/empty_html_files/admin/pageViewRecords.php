				...
				<table class="table">
					...
					<tr>
						<td align="center">
							Show records from
							<?php
								$arrFields=array('', 'biblio_author', 'biblio_doc', 'biblio_trascript', 'biblio_token', 'code_invivo', 'code_herme', 'code_chrev_scenes', 'code_character_development', 'code_encounters', 'code_encounter_scenes', 'story', 'story_characters', 'storypoints_static', 'storydynamic', 'storyweaving_scenes', 'storylines', 'storyboard', 'dictionary', 'class_agent_type1', 'class_agent_type2', 'class_authority_agent', 'class_authority_library', 'class_bibliography_genre', 'class_bibliography_type', 'class_bibliography_archive', 'class_dramatica_archetype', 'class_dramatica_domain', 'class_dramatica_concern', 'class_dramatica_issue', 'class_dramatica_themes', 'class_dramatica_throughline', 'class_im', 'class_language', 'class_nt', 'class_character_element', 'class_rights');
								$arrFieldCaptions=array('All tables', 'Agents', 'Bibliography', 'Trascripts', 'Token', 'Invivo', 'Hermeneutic', 'Character scenes', 'Character dev.', 'Encounters', 'Encounter scenes', 'Story', 'Characters', 'Storypoints', 'Story dynamics', 'Storyweaving', 'Storylines', 'Storyboard', 'Dictionary', 'Class agenttype1', 'Class agenttype2', 'Person\'s authority register', 'class_authority_library', 'Genre', 'Type', 'Archives', 'Archetype', 'Domain', 'Concern', 'Issue', 'Themes', 'Throughline', 'Impression', 'Language', 'Noetic tension', 'Character elements', 'Class rights');
