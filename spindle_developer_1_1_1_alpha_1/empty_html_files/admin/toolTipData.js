...
// storyboard table
storyboard_addTip=["",spacer+"This option allows all members of the group to add records to the 'Storyboard' table. A member who adds a record to the table becomes the 'owner' of that record."];

storyboard_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Storyboard' table."];
storyboard_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Storyboard' table."];
storyboard_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Storyboard' table."];
storyboard_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Storyboard' table."];

storyboard_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Storyboard' table."];
storyboard_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Storyboard' table."];
storyboard_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Storyboard' table."];
storyboard_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Storyboard' table, regardless of their owner."];

storyboard_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Storyboard' table."];
storyboard_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Storyboard' table."];
storyboard_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Storyboard' table."];
storyboard_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Storyboard' table."];
...
// class_bibliography_archive table
class_bibliography_archive_addTip=["",spacer+"This option allows all members of the group to add records to the 'Archives' table. A member who adds a record to the table becomes the 'owner' of that record."];

class_bibliography_archive_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Archives' table."];
class_bibliography_archive_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Archives' table."];
class_bibliography_archive_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Archives' table."];
class_bibliography_archive_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Archives' table."];

class_bibliography_archive_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Archives' table."];
class_bibliography_archive_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Archives' table."];
class_bibliography_archive_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Archives' table."];
class_bibliography_archive_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Archives' table, regardless of their owner."];

class_bibliography_archive_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Archives' table."];
class_bibliography_archive_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Archives' table."];
class_bibliography_archive_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Archives' table."];
class_bibliography_archive_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Archives' table."];
