<?php
	...
	if($_POST['saveChanges']!=''){
		...
		###############################
		$storyboard_insert=checkPermissionVal('storyboard_insert');
		$storyboard_view=checkPermissionVal('storyboard_view');
		$storyboard_edit=checkPermissionVal('storyboard_edit');
		$storyboard_delete=checkPermissionVal('storyboard_delete');
		###############################
		...
		###############################
		$class_bibliography_archive_insert=checkPermissionVal('class_bibliography_archive_insert');
		$class_bibliography_archive_view=checkPermissionVal('class_bibliography_archive_view');
		$class_bibliography_archive_edit=checkPermissionVal('class_bibliography_archive_edit');
		$class_bibliography_archive_delete=checkPermissionVal('class_bibliography_archive_delete');
		###############################
		...
		if($_POST['groupID']==''){ // new group
			...
			sql("delete from membership_grouppermissions where groupID='$groupID' and tableName='storyboard'", $eo);
			...
			sql("delete from membership_grouppermissions where groupID='$groupID' and tableName='class_bibliography_archive'", $eo);
		...
		if($groupID){
			...
			// table 'storyboard'
			sql("insert into membership_grouppermissions set groupID='$groupID', tableName='storyboard', allowInsert='$storyboard_insert', allowView='$storyboard_view', allowEdit='$storyboard_edit', allowDelete='$storyboard_delete'", $eo);
			// table 'dictionary'
			...
			// table 'class_bibliography_archive'
			sql("insert into membership_grouppermissions set groupID='$groupID', tableName='class_bibliography_archive', allowInsert='$class_bibliography_archive_insert', allowView='$class_bibliography_archive_view', allowEdit='$class_bibliography_archive_edit', allowDelete='$class_bibliography_archive_delete'", $eo);
	...
	<div class="table-responsive"><table class="table table-striped">
		...
		<tr>
			<td colspan="2" class="tdFormHeader">
				...
				<!-- storyboard table -->
					<tr>
						<td class="tdCaptionCell" valign="top">Storyboard</td>
						<td class="tdCell" valign="top">
							<input onMouseOver="stm(storyboard_addTip, toolTipStyle);" onMouseOut="htm();" type="checkbox" name="storyboard_insert" value="1" <?php echo ($storyboard_insert ? "checked class=\"highlight\"" : ""); ?>>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("storyboard_view", $arrPermVal, $arrPermText, $storyboard_view, "highlight");
							?>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("storyboard_edit", $arrPermVal, $arrPermText, $storyboard_edit, "highlight");
							?>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("storyboard_delete", $arrPermVal, $arrPermText, $storyboard_delete, "highlight");
							?>
							</td>
						</tr>
				<!-- dictionary table -->
				...
				<!-- class_bibliography_archive table -->
					<tr>
						<td class="tdCaptionCell" valign="top">Archives</td>
						<td class="tdCell" valign="top">
							<input onMouseOver="stm(class_bibliography_archive_addTip, toolTipStyle);" onMouseOut="htm();" type="checkbox" name="class_bibliography_archive_insert" value="1" <?php echo ($class_bibliography_archive_insert ? "checked class=\"highlight\"" : ""); ?>>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("class_bibliography_archive_view", $arrPermVal, $arrPermText, $class_bibliography_archive_view, "highlight");
							?>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("class_bibliography_archive_edit", $arrPermVal, $arrPermText, $class_bibliography_archive_edit, "highlight");
							?>
							</td>
						<td class="tdCell">
							<?php
								echo htmlRadioGroup("class_bibliography_archive_delete", $arrPermVal, $arrPermText, $class_bibliography_archive_delete, "highlight");
							?>
							</td>
						</tr>
