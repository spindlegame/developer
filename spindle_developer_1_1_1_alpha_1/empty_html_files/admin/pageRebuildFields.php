<?php
	...
	$schema = array(   
		'biblio_author' => array(   
			...
			'knows' => array('appgini' => 'VARCHAR(255) '),
		...
		'biblio_doc' => array(   
			...
			'authority_record' => array('appgini' => 'VARCHAR(255) '),
			'authority_organization' => array('appgini' => 'INT(10) unsigned '),
			'archive' => array('appgini' => 'VARCHAR(40) '),
		...
		'code_herme' => array(   
			...
			'symbols' => array('appgini' => 'VARCHAR(40) '),
			'freecode' => array('appgini' => 'LONGTEXT ')
		),
		'code_chrev_scenes' => array(   
			...
			'start_date' => array('appgini' => 'INT(10) unsigned '),
			'end_date' => array('appgini' => 'INT(10) unsigned '),
			...
			'impression' => array('appgini' => 'INT(10) unsigned '),
			'noetictension' => array('appgini' => 'INT(10) unsigned '),
			'symbols' => array('appgini' => 'INT(10) unsigned '),
		...
		'story_characters' => array(   
			...
			'drama_role' => array('appgini' => 'VARCHAR(255) '),
			'drama_function' => array('appgini' => 'VARCHAR(255) '),
			...
			'cw_gender' => array('appgini' => 'VARCHAR(40) '),
		...
		'storydynamic' => array(   
			...
			'analyse_essence' => array('appgini' => 'VARCHAR(255) '),
			'analyse_nature' => array('appgini' => 'VARCHAR(40) '),
			'analyse_tendency' => array('appgini' => 'VARCHAR(40) '),
			'analyse_reach' => array('appgini' => 'VARCHAR(40) ')
		),
		'storyweaving_scenes' => array(   
			'id' => array('appgini' => 'INT(10) unsigned not null primary key auto_increment '),
			'weaving_no' => array('appgini' => 'VARCHAR(40) '),
			'story' => array('appgini' => 'INT(10) unsigned '),
		...
		'storylines' => array(   
			...
			'storyline' => array('appgini' => 'LONGTEXT '),
			'story_appreciation' => array('appgini' => 'VARCHAR(255) '),
			'story_appreciation_value' => array('appgini' => 'VARCHAR(255) '),
			'effect_character' => array('appgini' => 'TEXT '),
			'effect_plot' => array('appgini' => 'TEXT '),
			'effect_theme' => array('appgini' => 'TEXT '),
			'storydynamic_point' => array('appgini' => 'VARCHAR(255) '),
			'storydynamic_value' => array('appgini' => 'VARCHAR(255) '),
			'author_note' => array('appgini' => 'TEXT '),
			'director_note' => array('appgini' => 'TEXT '),
			'editor_note' => array('appgini' => 'TEXT ')
		),
		'storyboard' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'scene' => array('appgini' => 'INT(10) unsigned '),
			'shot' => array('appgini' => 'VARCHAR(255) ')
		),
		'dictionary' => array(   
			'id' => array('appgini' => 'INT(10) unsigned not null primary key auto_increment '),
		...
		'class_bibliography_archive' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'organization_abr' => array('appgini' => 'VARCHAR(40) '),
			'organization' => array('appgini' => 'VARCHAR(255) '),
			'address_street' => array('appgini' => 'VARCHAR(255) '),
			'address_place' => array('appgini' => 'VARCHAR(40) '),
			'address_pc' => array('appgini' => 'VARCHAR(40) '),
			'address_region' => array('appgini' => 'VARCHAR(40) '),
			'address_country' => array('appgini' => 'VARCHAR(40) '),
			'phone1' => array('appgini' => 'VARCHAR(40) '),
			'email1' => array('appgini' => 'VARCHAR(80) '),
			'web1' => array('appgini' => 'VARCHAR(40) ')
		),
