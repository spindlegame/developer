	...
	*/
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				'biblio_author' => 'Agents',
				'biblio_doc' => 'Bibliography',
				'biblio_trascript' => 'Trascripts',
				'biblio_token' => 'Token',
				'code_invivo' => 'Invivo',
				'code_herme' => 'Hermeneutic',
				'code_chrev_scenes' => 'Character scenes',
				'code_character_development' => 'Character dev.',
				'code_encounters' => 'Encounters',
				'code_encounter_scenes' => 'Encounter scenes',
				'story' => 'Story',
				'story_characters' => 'Characters',
				'storypoints_static' => 'Storypoints',
				'storydynamic' => 'Story dynamics',
				'storyweaving_scenes' => 'Storyweaving',
				'storylines' => 'Storylines',
				'storyboard' => 'Storyboard',
				'dictionary' => 'Dictionary',
				'class_agent_type1' => 'Class agenttype1',
				'class_agent_type2' => 'Class agenttype2',
				'class_authority_agent' => 'Person\'s authority register',
				'class_authority_library' => 'class_authority_library',
				'class_bibliography_genre' => 'Genre',
				'class_bibliography_type' => 'Type',
				'class_bibliography_archive' => 'Archives',
				'class_dramatica_archetype' => 'Archetype',
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		...
		elseif($tableName=='biblio_doc' && $fieldName=='img' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='storyboard' && $fieldName=='shot' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='storyboard' && $fieldName=='shot' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['spindle_rememberMe'])){
			setcookie('spindle_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
