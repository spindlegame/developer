<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('story', "create table if not exists `story` (   `id` INT(10) unsigned not null auto_increment , primary key (`id`), `subject` VARCHAR(40) , `story` VARCHAR(255) , `tags` VARCHAR(80) , `collaboration_status` VARCHAR(40) , `synopsis_backstory` TEXT ) CHARSET utf8", $silent);
		setupTable('story_characters', "create table if not exists `story_characters` (   `id` INT(10) unsigned not null auto_increment , primary key (`id`), `story` INT(10) unsigned , `role` INT(10) unsigned , `character` VARCHAR(40) , `memberID` INT unsigned , `agent_name` INT unsigned , `cw_name` VARCHAR(40) , `img` INT unsigned , `drama_role` VARCHAR(255) , `drama_function` VARCHAR(255) , `MC_resolve` INT(10) unsigned , `MC_growth` INT(10) unsigned , `MC_approach` INT(10) unsigned , `MC_PS_style` INT(10) unsigned , `cw_age` VARCHAR(40) , `cw_gender` VARCHAR(40) , `cw_communication_style` TEXT , `cw_background` TEXT , `cw_appearance` TEXT , `cw_relationships` VARCHAR(255) , `cw_ambition` TEXT , `cw_character_defects` TEXT , `cw_thoughts` TEXT , `cw_relatedness` VARCHAR(255) , `cw_restrictions` TEXT , `locations` VARCHAR(255) , `persons` VARCHAR(255) , `events` TEXT , `noetictension` INT(10) unsigned , `impression` INT(10) unsigned ) CHARSET utf8", $silent);
		...
		setupTable('class_bibliography_archive', "create table if not exists `class_bibliography_archive` (   `id` INT unsigned not null auto_increment , primary key (`id`), `organization_abr` VARCHAR(40) , `organization` VARCHAR(255) , `address_street` VARCHAR(255) , `address_place` VARCHAR(40) , `address_pc` VARCHAR(40) , `address_region` VARCHAR(40) , `address_country` VARCHAR(40) , `phone1` VARCHAR(40) , `email1` VARCHAR(80) , `web1` VARCHAR(40) ) CHARSET utf8", $silent);
