...
function code_character_development_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_code->HTML = '<span id="code-container' . $rnd1 . '"></span><input type="hidden" name="code" id="code' . $rnd1 . '" value="' . htmlspecialchars($combo_code->SelectedData) . '">';
	$combo_code->MatchText = '<span id="code-container-readonly' . $rnd1 . '"></span><input type="hidden" name="code" id="code' . $rnd1 . '" value="' . htmlspecialchars($combo_code->SelectedData) . '">';
	$combo_character_element->HTML = '<span id="character_element-container' . $rnd1 . '"></span><input type="hidden" name="character_element" id="character_element' . $rnd1 . '" value="' . htmlspecialchars($combo_character_element->SelectedData) . '">';
	$combo_character_element->MatchText = '<span id="character_element-container-readonly' . $rnd1 . '"></span><input type="hidden" name="character_element" id="character_element' . $rnd1 . '" value="' . htmlspecialchars($combo_character_element->SelectedData) . '">';
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#character_elem_value').replaceWith('<div class=\"form-control-static\" id=\"character_elem_value\">' + (jQuery('#character_elem_value').val() || '') + '</div>');\n";
	...
	$parent_tables = array(  'story' => array('story', 'Story'), 'story_characters' => array('agent', 'Agent'), 'biblio_author' => array('author', 'Author'), 'biblio_doc' => array('bibliography', 'Bibliography'), 'biblio_trascript' => array('transcript', 'Transcript'), 'biblio_token' => array('token', 'Token'), 'code_herme' => array('code', 'Code'), 'class_character_element' => array('character_element', 'Character element'));
