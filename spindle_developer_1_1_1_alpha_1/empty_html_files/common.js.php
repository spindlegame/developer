...
function biblio_author_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function biblio_doc_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function biblio_trascript_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function biblio_token_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_invivo_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_herme_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_chrev_scenes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_character_development_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_encounters_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function code_encounter_scenes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function story_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function story_characters_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function storypoints_static_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function storydynamic_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function storyweaving_scenes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function storylines_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function storyboard_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function dictionary_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_agent_type1_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_agent_type2_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_authority_agent_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_authority_library_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_bibliography_genre_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_bibliography_type_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_bibliography_archive_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_archetype_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_domain_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_concern_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_issue_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_themes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_dramatica_throughline_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_im_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_language_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_nt_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_character_element_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function class_rights_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
