...
function biblio_doc_insert(){
	...
	$data['archive'] = makeSafe($_POST['archive']);
		if($data['archive'] == empty_lookup_value){ $data['archive'] = ''; }
...
function biblio_doc_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_author_name->HTML = '<span id="author_name-container' . $rnd1 . '"></span><input type="hidden" name="author_name" id="author_name' . $rnd1 . '" value="' . htmlspecialchars($combo_author_name->SelectedData) . '">';
	$combo_author_name->MatchText = '<span id="author_name-container-readonly' . $rnd1 . '"></span><input type="hidden" name="author_name" id="author_name' . $rnd1 . '" value="' . htmlspecialchars($combo_author_name->SelectedData) . '">';
	$combo_type->HTML = '<span id="type-container' . $rnd1 . '"></span><input type="hidden" name="type" id="type' . $rnd1 . '" value="' . htmlspecialchars($combo_type->SelectedData) . '">';
	$combo_type->MatchText = '<span id="type-container-readonly' . $rnd1 . '"></span><input type="hidden" name="type" id="type' . $rnd1 . '" value="' . htmlspecialchars($combo_type->SelectedData) . '">';
	$combo_genre->HTML = '<span id="genre-container' . $rnd1 . '"></span><input type="hidden" name="genre" id="genre' . $rnd1 . '" value="' . htmlspecialchars($combo_genre->SelectedData) . '">';
	$combo_genre->MatchText = '<span id="genre-container-readonly' . $rnd1 . '"></span><input type="hidden" name="genre" id="genre' . $rnd1 . '" value="' . htmlspecialchars($combo_genre->SelectedData) . '">';
	$combo_language->HTML = '<span id="language-container' . $rnd1 . '"></span><input type="hidden" name="language" id="language' . $rnd1 . '" value="' . htmlspecialchars($combo_language->SelectedData) . '">';
	$combo_language->MatchText = '<span id="language-container-readonly' . $rnd1 . '"></span><input type="hidden" name="language" id="language' . $rnd1 . '" value="' . htmlspecialchars($combo_language->SelectedData) . '">';
	$combo_rights->HTML = '<span id="rights-container' . $rnd1 . '"></span><input type="hidden" name="rights" id="rights' . $rnd1 . '" value="' . htmlspecialchars($combo_rights->SelectedData) . '">';
	$combo_rights->MatchText = '<span id="rights-container-readonly' . $rnd1 . '"></span><input type="hidden" name="rights" id="rights' . $rnd1 . '" value="' . htmlspecialchars($combo_rights->SelectedData) . '">';
	$combo_data_evaluation->Render();
	$combo_authority_organization->HTML = '<span id="authority_organization-container' . $rnd1 . '"></span><input type="hidden" name="authority_organization" id="authority_organization' . $rnd1 . '" value="' . htmlspecialchars($combo_authority_organization->SelectedData) . '">';
	$combo_authority_organization->MatchText = '<span id="authority_organization-container-readonly' . $rnd1 . '"></span><input type="hidden" name="authority_organization" id="authority_organization' . $rnd1 . '" value="' . htmlspecialchars($combo_authority_organization->SelectedData) . '">';
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#created').replaceWith('<div class=\"form-control-static\" id=\"created\">' + (jQuery('#created').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#published').replaceWith('<div class=\"form-control-static\" id=\"published\">' + (jQuery('#published').val() || '') + '</div>');\n";
		...
		$jsReadOnly .= "\tjQuery('#data_evaluation').replaceWith('<div class=\"form-control-static\" id=\"data_evaluation\">' + (jQuery('#data_evaluation').val() || '') + '</div>'); jQuery('#data_evaluation-multi-selection-help').hide();\n";
		...
		$jsReadOnly .= "\tjQuery('#archive').replaceWith('<div class=\"form-control-static\" id=\"archive\">' + (jQuery('#archive').val() || '') + '</div>');\n";
	...
	$parent_tables = array(  'biblio_author' => array('author_name', 'Author name'), 'class_bibliography_type' => array('type', 'Document type'), 'class_bibliography_genre' => array('genre', 'Genre'), 'class_language' => array('language', 'Language'), 'class_rights' => array('rights', 'Rights'), 'class_authority_library' => array('authority_organization', 'Authority organization'));
	...
	$templateCode=str_replace('<%%UPLOADFILE(archive)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(pdf_book)%%>', ($noUploads ? '' : '<input type=hidden name=MAX_FILE_SIZE value=92160000>'.$Translation['upload image'].' <input type="file" name="pdf_book" id="pdf_book">'), $templateCode);
	...
	if($selected_id){
		...
		$templateCode=str_replace('<%%VALUE(archive)%%>', htmlspecialchars($row['archive'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(archive)%%>', urlencode($urow['archive']), $templateCode);
		...
		$templateCode=str_replace('<%%VALUE(archive)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(archive)%%>', urlencode(''), $templateCode);
