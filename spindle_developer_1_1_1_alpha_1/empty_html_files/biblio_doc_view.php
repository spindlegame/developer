...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->ColCaption = array("id", "Img", "Author name", "Published", "Title", "Publisher", "Place of publication", "Archive", "Pdf book", "External source");
	$x->ColFieldName = array('id', 'img', 'author_name', 'published', 'title', 'publisher', 'location', 'archive', 'pdf_book', 'ext_source');
	$x->ColNumber  = array(1, 2, 3, 8, 9, 11, 12, 25, 26, 27);
