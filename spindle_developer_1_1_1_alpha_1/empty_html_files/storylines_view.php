...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV=array(   
		...
		"IF(    CHAR_LENGTH(`storyweaving_scenes1`.`id`) || CHAR_LENGTH(`class_dramatica_throughline1`.`throughline`), CONCAT_WS('',   `storyweaving_scenes1`.`id`, `class_dramatica_throughline1`.`throughline`), '') /* Storyweaving scene no. */" => "storyweaving_scene_no",
		"IF(    CHAR_LENGTH(`storyweaving_scenes1`.`step`) || CHAR_LENGTH(`class_dramatica_throughline2`.`throughline`), CONCAT_WS('',   `storyweaving_scenes1`.`step`, '  ', `class_dramatica_throughline2`.`throughline`), '') /* Storyweaving scene */" => "storyweaving_scene",
		...
		"`storylines`.`story_appreciation`" => "story_appreciation",
		"`storylines`.`story_appreciation_value`" => "story_appreciation_value",
		"`storylines`.`effect_character`" => "effect_character",
		"`storylines`.`effect_plot`" => "effect_plot",
		"`storylines`.`effect_theme`" => "effect_theme",
		"`storylines`.`storydynamic_point`" => "storydynamic_point",
		"`storylines`.`storydynamic_value`" => "storydynamic_value",
		"`storylines`.`author_note`" => "author_note",
		"`storylines`.`director_note`" => "director_note",
		"`storylines`.`editor_note`" => "editor_note"
	);
	...
	$x->QueryFieldsFilters=array(   
		...
		"IF(    CHAR_LENGTH(`storyweaving_scenes1`.`id`) || CHAR_LENGTH(`class_dramatica_throughline1`.`throughline`), CONCAT_WS('',   `storyweaving_scenes1`.`id`, `class_dramatica_throughline1`.`throughline`), '') /* Storyweaving scene no. */" => "Storyweaving scene no.",
		"IF(    CHAR_LENGTH(`storyweaving_scenes1`.`step`) || CHAR_LENGTH(`class_dramatica_throughline2`.`throughline`), CONCAT_WS('',   `storyweaving_scenes1`.`step`, '  ', `class_dramatica_throughline2`.`throughline`), '') /* Storyweaving scene */" => "Storyweaving scene",
		...
		"`storylines`.`storyline`" => "Storyline",
		"`storylines`.`story_appreciation`" => "Story appreciation",
		"`storylines`.`story_appreciation_value`" => "Story appreciation value",
		"`storylines`.`effect_character`" => "Effect character",
		"`storylines`.`effect_plot`" => "Effect plot",
		"`storylines`.`effect_theme`" => "Effect theme",
		"`storylines`.`storydynamic_point`" => "Storydynamic ",
		"`storylines`.`storydynamic_value`" => "Storydynamic value",
		"`storylines`.`author_note`" => "Author note",
		"`storylines`.`director_note`" => "Director note",
		"`storylines`.`editor_note`" => "Editor note"
	);
