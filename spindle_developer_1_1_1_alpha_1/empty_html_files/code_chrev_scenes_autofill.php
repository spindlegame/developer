...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	switch($mfk){
		...
		case 'start_date':
			if(!$id){
				?>
				$('invivo_code<?php echo $rnd1; ?>').innerHTML='&nbsp;';
			...
			$row = db_fetch_assoc($res);
			?>
			$('invivo_code<?php echo $rnd1; ?>').innerHTML = '<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['id'].' / '.$row['token_sequence']))); ?>&nbsp;';
		...
		case 'herme_code':
			if(!$id){
				...
				$('symbols<?php echo $rnd1; ?>').innerHTML='&nbsp;';
			...
			$('symbols<?php echo $rnd1; ?>').innerHTML = '<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['symbols']))); ?>&nbsp;';
