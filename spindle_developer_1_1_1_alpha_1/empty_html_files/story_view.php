...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV=array(   
		...
		"`story`.`story`" => "story",
		"`story`.`tags`" => "tags",
		"`story`.`collaboration_status`" => "collaboration_status",
		"`story`.`synopsis_backstory`" => "synopsis_backstory"
	);
	...
	$x->QueryFieldsFilters=array(   
		...
		"`story`.`story`" => "Title",
		"`story`.`tags`" => "Tags",
		"`story`.`collaboration_status`" => "Collaboration status",
		"`story`.`synopsis_backstory`" => "Synopsis backstory"
	);
	...
	$x->ColCaption = array("id", "Subject", "Title", "Tags", "Collaboration status");
	$x->ColFieldName = array('id', 'subject', 'story', 'tags', 'collaboration_status');
