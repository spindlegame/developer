...
// Download AppGini for free from http://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV=array(   
		...
		"`story_characters`.`drama_role`" => "drama_role",
		"`story_characters`.`drama_function`" => "drama_function",
	...
	$x->SortFields = array(   
		...
		9 => 9,
		10 => 10,
		11 => '`story_characters`.`MC_resolve`',
		12 => '`story_characters`.`MC_growth`',
		13 => '`story_characters`.`MC_approach`',
		14 => '`story_characters`.`MC_PS_style`',
		15 => 15,
		16 => 16,
		17 => 17,
		18 => 18,
	...
	$x->QueryFieldsFilters=array(   
		...
		"`story_characters`.`drama_role`" => "Drama role",
		"`story_characters`.`drama_function`" => "Dramatic function",
