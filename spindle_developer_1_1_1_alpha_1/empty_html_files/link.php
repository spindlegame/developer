<?php
	...
	$p=array(   
		'biblio_author' => array(
			'img' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'biblio_doc' => array(
			'img' => $Translation['ImageFolder'],
			'pdf_book' => $Translation['ImageFolder'],
			'ext_source' => '',
			'primary key' => 'id'
		),
		'biblio_trascript' => array(
			'transcript' => $Translation['ImageFolder'],
			'credits' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'storyboard' => array(
			'shot' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
