...
function code_encounters_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_agentA->HTML = '<span id="agentA-container' . $rnd1 . '"></span><input type="hidden" name="agentA" id="agentA' . $rnd1 . '" value="' . htmlspecialchars($combo_agentA->SelectedData) . '">';
	$combo_agentA->MatchText = '<span id="agentA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="agentA" id="agentA' . $rnd1 . '" value="' . htmlspecialchars($combo_agentA->SelectedData) . '">';
	$combo_authorA->HTML = '<span id="authorA-container' . $rnd1 . '"></span><input type="hidden" name="authorA" id="authorA' . $rnd1 . '" value="' . htmlspecialchars($combo_authorA->SelectedData) . '">';
	$combo_authorA->MatchText = '<span id="authorA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="authorA" id="authorA' . $rnd1 . '" value="' . htmlspecialchars($combo_authorA->SelectedData) . '">';
	$combo_bibliographyA->HTML = '<span id="bibliographyA-container' . $rnd1 . '"></span><input type="hidden" name="bibliographyA" id="bibliographyA' . $rnd1 . '" value="' . htmlspecialchars($combo_bibliographyA->SelectedData) . '">';
	$combo_bibliographyA->MatchText = '<span id="bibliographyA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="bibliographyA" id="bibliographyA' . $rnd1 . '" value="' . htmlspecialchars($combo_bibliographyA->SelectedData) . '">';
	$combo_transcriptA->HTML = '<span id="transcriptA-container' . $rnd1 . '"></span><input type="hidden" name="transcriptA" id="transcriptA' . $rnd1 . '" value="' . htmlspecialchars($combo_transcriptA->SelectedData) . '">';
	$combo_transcriptA->MatchText = '<span id="transcriptA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="transcriptA" id="transcriptA' . $rnd1 . '" value="' . htmlspecialchars($combo_transcriptA->SelectedData) . '">';
	$combo_tokenA->HTML = '<span id="tokenA-container' . $rnd1 . '"></span><input type="hidden" name="tokenA" id="tokenA' . $rnd1 . '" value="' . htmlspecialchars($combo_tokenA->SelectedData) . '">';
	$combo_tokenA->MatchText = '<span id="tokenA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="tokenA" id="tokenA' . $rnd1 . '" value="' . htmlspecialchars($combo_tokenA->SelectedData) . '">';
	$combo_sceneA->HTML = '<span id="sceneA-container' . $rnd1 . '"></span><input type="hidden" name="sceneA" id="sceneA' . $rnd1 . '" value="' . htmlspecialchars($combo_sceneA->SelectedData) . '">';
	$combo_sceneA->MatchText = '<span id="sceneA-container-readonly' . $rnd1 . '"></span><input type="hidden" name="sceneA" id="sceneA' . $rnd1 . '" value="' . htmlspecialchars($combo_sceneA->SelectedData) . '">';
	$combo_agentB->HTML = '<span id="agentB-container' . $rnd1 . '"></span><input type="hidden" name="agentB" id="agentB' . $rnd1 . '" value="' . htmlspecialchars($combo_agentB->SelectedData) . '">';
	$combo_agentB->MatchText = '<span id="agentB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="agentB" id="agentB' . $rnd1 . '" value="' . htmlspecialchars($combo_agentB->SelectedData) . '">';
	$combo_authorB->HTML = '<span id="authorB-container' . $rnd1 . '"></span><input type="hidden" name="authorB" id="authorB' . $rnd1 . '" value="' . htmlspecialchars($combo_authorB->SelectedData) . '">';
	$combo_authorB->MatchText = '<span id="authorB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="authorB" id="authorB' . $rnd1 . '" value="' . htmlspecialchars($combo_authorB->SelectedData) . '">';
	$combo_bibliographyB->HTML = '<span id="bibliographyB-container' . $rnd1 . '"></span><input type="hidden" name="bibliographyB" id="bibliographyB' . $rnd1 . '" value="' . htmlspecialchars($combo_bibliographyB->SelectedData) . '">';
	$combo_bibliographyB->MatchText = '<span id="bibliographyB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="bibliographyB" id="bibliographyB' . $rnd1 . '" value="' . htmlspecialchars($combo_bibliographyB->SelectedData) . '">';
	$combo_transcriptB->HTML = '<span id="transcriptB-container' . $rnd1 . '"></span><input type="hidden" name="transcriptB" id="transcriptB' . $rnd1 . '" value="' . htmlspecialchars($combo_transcriptB->SelectedData) . '">';
	$combo_transcriptB->MatchText = '<span id="transcriptB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="transcriptB" id="transcriptB' . $rnd1 . '" value="' . htmlspecialchars($combo_transcriptB->SelectedData) . '">';
	$combo_tokenB->HTML = '<span id="tokenB-container' . $rnd1 . '"></span><input type="hidden" name="tokenB" id="tokenB' . $rnd1 . '" value="' . htmlspecialchars($combo_tokenB->SelectedData) . '">';
	$combo_tokenB->MatchText = '<span id="tokenB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="tokenB" id="tokenB' . $rnd1 . '" value="' . htmlspecialchars($combo_tokenB->SelectedData) . '">';
	$combo_sceneB->HTML = '<span id="sceneB-container' . $rnd1 . '"></span><input type="hidden" name="sceneB" id="sceneB' . $rnd1 . '" value="' . htmlspecialchars($combo_sceneB->SelectedData) . '">';
	$combo_sceneB->MatchText = '<span id="sceneB-container-readonly' . $rnd1 . '"></span><input type="hidden" name="sceneB" id="sceneB' . $rnd1 . '" value="' . htmlspecialchars($combo_sceneB->SelectedData) . '">';
	$combo_type->Render();
	$combo_conflicttype->Render();
	$combo_story_scene->HTML = '<span id="story_scene-container' . $rnd1 . '"></span><input type="hidden" name="story_scene" id="story_scene' . $rnd1 . '" value="' . htmlspecialchars($combo_story_scene->SelectedData) . '">';
	$combo_story_scene->MatchText = '<span id="story_scene-container-readonly' . $rnd1 . '"></span><input type="hidden" name="story_scene" id="story_scene' . $rnd1 . '" value="' . htmlspecialchars($combo_story_scene->SelectedData) . '">';
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#conflicttype').replaceWith('<div class=\"form-control-static\" id=\"conflicttype\">' + (jQuery('#conflicttype').val() || '') + '</div>'); jQuery('#conflicttype-multi-selection-help').hide();\n";
	...
	$parent_tables = array(  'biblio_author' => array('agentA', 'Agent A'), 'biblio_author' => array('authorA', 'Author A'), 'biblio_doc' => array('bibliographyA', 'Bibliography A'), 'biblio_trascript' => array('transcriptA', 'Transcript A'), 'biblio_token' => array('tokenA', 'Token A'), 'code_encounter_scenes' => array('sceneA', 'Scene A'), 'biblio_author' => array('agentB', 'Agent B'), 'biblio_author' => array('authorB', 'Author B'), 'biblio_doc' => array('bibliographyB', 'Bibliography B'), 'biblio_trascript' => array('transcriptB', 'Transcript B'), 'biblio_token' => array('tokenB', 'Token B'), 'code_encounter_scenes' => array('sceneB', 'Scene B'), 'code_encounter_scenes' => array('story_scene', 'Story Scene'));
