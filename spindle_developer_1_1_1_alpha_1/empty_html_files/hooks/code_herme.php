<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'code_herme' table. 
	...
	*/
	...
	function code_herme_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function code_herme_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['impression'], $data['noetictension'], $data['symbols'], $data['freecode']
	...
	*/
	...
	function code_herme_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['impression'], $data['noetictension'], $data['symbols'], $data['freecode']
	...
	*/
	...
	function code_herme_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function code_herme_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function code_herme_batch_actions(&$args){
