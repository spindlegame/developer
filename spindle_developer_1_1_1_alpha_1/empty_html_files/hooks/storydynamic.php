<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storydynamic' table. 
	...
	*/
	...
	function storydynamic_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storydynamic_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['story'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['IC_resolve'], $data['OS_driver'], $data['OS_limit'], $data['OS_outcome'], $data['OS_judgement'], $data['OS_goal_domain'], $data['OS_goal_concern'], $data['OS_consequence_domain'], $data['OS_consequence_concern'], $data['OS_cost_domain'], $data['OS_cost_concern'], $data['OS_dividend_domain'], $data['OS_dividend_concern'], $data['OS_requirements_domain'], $data['OS_requirements_concern'], $data['OS_prerequesites_domain'], $data['OS_prerequesites_concern'], $data['OS_preconditions_domain'], $data['OS_preconditions_concern'], $data['OS_forewarnings_domain'], $data['OS_forewarnings_concern'], $data['analyse_essence'], $data['analyse_nature'], $data['analyse_tendency'], $data['analyse_reach']
	...
	*/
	...
	function storydynamic_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['IC_resolve'], $data['OS_driver'], $data['OS_limit'], $data['OS_outcome'], $data['OS_judgement'], $data['OS_goal_domain'], $data['OS_goal_concern'], $data['OS_consequence_domain'], $data['OS_consequence_concern'], $data['OS_cost_domain'], $data['OS_cost_concern'], $data['OS_dividend_domain'], $data['OS_dividend_concern'], $data['OS_requirements_domain'], $data['OS_requirements_concern'], $data['OS_prerequesites_domain'], $data['OS_prerequesites_concern'], $data['OS_preconditions_domain'], $data['OS_preconditions_concern'], $data['OS_forewarnings_domain'], $data['OS_forewarnings_concern'], $data['analyse_essence'], $data['analyse_nature'], $data['analyse_tendency'], $data['analyse_reach']
	...
	*/
	...
	function storydynamic_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storydynamic_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storydynamic_batch_actions(&$args){
