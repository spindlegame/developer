<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storyweaving_scenes' table. 
	...
	*/
	...
	function storyweaving_scenes_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storyweaving_scenes_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['weaving_no'], $data['story'], $data['step'], $data['throughline'], $data['domain'], $data['concern'], $data['sequence'], $data['issue'], $data['theme']
	...
	*/
	...
	function storyweaving_scenes_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['weaving_no'], $data['story'], $data['step'], $data['throughline'], $data['domain'], $data['concern'], $data['sequence'], $data['issue'], $data['theme']
	...
	*/
	...
	function storyweaving_scenes_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storyweaving_scenes_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_batch_actions(&$args){
