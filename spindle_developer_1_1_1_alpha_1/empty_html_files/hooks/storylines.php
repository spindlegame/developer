<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storylines' table. 
	...
	*/
	...
	function storylines_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storylines_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storylines_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['story'], $data['story_act'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['role'], $data['character'], $data['characterevent_scene'], $data['character_event'], $data['storyline_no'], $data['storyline'], $data['story_appreciation'], $data['story_appreciation_value'], $data['effect_character'], $data['effect_plot'], $data['effect_theme'], $data['storydynamic_point'], $data['storydynamic_value'], $data['author_note'], $data['director_note'], $data['editor_note']
	...
	*/
	...
	function storylines_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storylines_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['story_act'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['role'], $data['character'], $data['characterevent_scene'], $data['character_event'], $data['storyline_no'], $data['storyline'], $data['story_appreciation'], $data['story_appreciation_value'], $data['effect_character'], $data['effect_plot'], $data['effect_theme'], $data['storydynamic_point'], $data['storydynamic_value'], $data['author_note'], $data['director_note'], $data['editor_note']
	...
	*/
	...
	function storylines_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storylines_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storylines_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storylines_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storylines_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storylines_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storylines_batch_actions(&$args){
