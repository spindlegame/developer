<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storyboard' table. 
	...
	*/
	...
	function storyboard_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storyboard_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function storyboard_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storyboard_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storyboard_batch_actions(&$args){
