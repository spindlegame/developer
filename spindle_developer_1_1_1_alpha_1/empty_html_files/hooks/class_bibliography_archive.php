<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_bibliography_archive' table. 
	...
	*/
	...
	function class_bibliography_archive_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_bibliography_archive_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['organization_abr'], $data['organization'], $data['address_street'], $data['address_place'], $data['address_pc'], $data['address_region'], $data['address_country'], $data['phone1'], $data['email1'], $data['web1']
	...
	*/
	...
	function class_bibliography_archive_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['organization_abr'], $data['organization'], $data['address_street'], $data['address_place'], $data['address_pc'], $data['address_region'], $data['address_country'], $data['phone1'], $data['email1'], $data['web1']
	...
	*/
	...
	function class_bibliography_archive_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_bibliography_archive_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_archive_batch_actions(&$args){
