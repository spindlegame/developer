<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'story_characters' table. 
	...
	*/
	...
	function story_characters_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function story_characters_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function story_characters_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['story'], $data['role'], $data['character'], $data['agent_name'], $data['cw_name'], $data['img'], $data['drama_role'], $data['drama_function'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_character_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['impression']
	...
	*/
	...
	function story_characters_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['story'], $data['role'], $data['character'], $data['memberID'], $data['agent_name'], $data['cw_name'], $data['img'], $data['drama_role'], $data['drama_function'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_character_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['impression']
	...
	*/
	...
	function story_characters_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['role'], $data['character'], $data['agent_name'], $data['cw_name'], $data['img'], $data['drama_role'], $data['drama_function'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_character_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['impression']
	...
	*/
	...
	function story_characters_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['role'], $data['character'], $data['memberID'], $data['agent_name'], $data['cw_name'], $data['img'], $data['drama_role'], $data['drama_function'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_character_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['impression']
	...
	*/
	...
	function story_characters_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function story_characters_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function story_characters_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function story_characters_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function story_characters_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function story_characters_batch_actions(&$args){
