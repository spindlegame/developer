<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'story' table. 
	...
	*/
	...
	function story_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function story_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function story_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['subject'], $data['story'], $data['tags'], $data['collaboration_status'], $data['synopsis_backstory']
	...
	*/
	...
	function story_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['subject'], $data['story'], $data['tags'], $data['collaboration_status'], $data['synopsis_backstory']
	...
	*/
	...
	function story_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function story_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function story_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function story_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function story_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function story_batch_actions(&$args){
