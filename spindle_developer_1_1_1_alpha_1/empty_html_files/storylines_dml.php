...
function storylines_insert(){
	...
	$data['story_appreciation'] = makeSafe($_POST['story_appreciation']);
		if($data['story_appreciation'] == empty_lookup_value){ $data['story_appreciation'] = ''; }
	$data['story_appreciation_value'] = makeSafe($_POST['story_appreciation_value']);
		if($data['story_appreciation_value'] == empty_lookup_value){ $data['story_appreciation_value'] = ''; }
	$data['effect_character'] = br2nl(makeSafe($_POST['effect_character']));
	$data['effect_plot'] = br2nl(makeSafe($_POST['effect_plot']));
	$data['effect_theme'] = br2nl(makeSafe($_POST['effect_theme']));
	$data['storydynamic_point'] = makeSafe($_POST['storydynamic_point']);
		if($data['storydynamic_point'] == empty_lookup_value){ $data['storydynamic_point'] = ''; }
	$data['storydynamic_value'] = makeSafe($_POST['storydynamic_value']);
		if($data['storydynamic_value'] == empty_lookup_value){ $data['storydynamic_value'] = ''; }
	$data['author_note'] = br2nl(makeSafe($_POST['author_note']));
	$data['director_note'] = br2nl(makeSafe($_POST['director_note']));
	$data['editor_note'] = br2nl(makeSafe($_POST['editor_note']));
	...
	sql('insert into `storylines` set       `story`=' . (($data['story'] !== '' && $data['story'] !== NULL) ? "'{$data['story']}'" : 'NULL') . ', `story_act`=' . (($data['story_act'] !== '' && $data['story_act'] !== NULL) ? "'{$data['story_act']}'" : 'NULL') . ', `storyweaving_scene_no`=' . (($data['storyweaving_scene_no'] !== '' && $data['storyweaving_scene_no'] !== NULL) ? "'{$data['storyweaving_scene_no']}'" : 'NULL') . ', `storyweaving_scene`=' . (($data['storyweaving_scene'] !== '' && $data['storyweaving_scene'] !== NULL) ? "'{$data['storyweaving_scene']}'" : 'NULL') . ', `storyweaving_sequence`=' . (($data['storyweaving_sequence'] !== '' && $data['storyweaving_sequence'] !== NULL) ? "'{$data['storyweaving_sequence']}'" : 'NULL') . ', `storyweaving_theme`=' . (($data['storyweaving_theme'] !== '' && $data['storyweaving_theme'] !== NULL) ? "'{$data['storyweaving_theme']}'" : 'NULL') . ', `role`=' . (($data['role'] !== '' && $data['role'] !== NULL) ? "'{$data['role']}'" : 'NULL') . ', `character`=' . (($data['character'] !== '' && $data['character'] !== NULL) ? "'{$data['character']}'" : 'NULL') . ', `characterevent_scene`=' . (($data['characterevent_scene'] !== '' && $data['characterevent_scene'] !== NULL) ? "'{$data['characterevent_scene']}'" : 'NULL') . ', `character_event`=' . (($data['character_event'] !== '' && $data['character_event'] !== NULL) ? "'{$data['character_event']}'" : 'NULL') . ', `storyline_no`=' . (($data['storyline_no'] !== '' && $data['storyline_no'] !== NULL) ? "'{$data['storyline_no']}'" : 'NULL') . ', `storyline`=' . (($data['storyline'] !== '' && $data['storyline'] !== NULL) ? "'{$data['storyline']}'" : 'NULL') . ', `story_appreciation`=' . (($data['story_appreciation'] !== '' && $data['story_appreciation'] !== NULL) ? "'{$data['story_appreciation']}'" : 'NULL') . ', `story_appreciation_value`=' . (($data['story_appreciation_value'] !== '' && $data['story_appreciation_value'] !== NULL) ? "'{$data['story_appreciation_value']}'" : 'NULL') . ', `effect_character`=' . (($data['effect_character'] !== '' && $data['effect_character'] !== NULL) ? "'{$data['effect_character']}'" : 'NULL') . ', `effect_plot`=' . (($data['effect_plot'] !== '' && $data['effect_plot'] !== NULL) ? "'{$data['effect_plot']}'" : 'NULL') . ', `effect_theme`=' . (($data['effect_theme'] !== '' && $data['effect_theme'] !== NULL) ? "'{$data['effect_theme']}'" : 'NULL') . ', `storydynamic_point`=' . (($data['storydynamic_point'] !== '' && $data['storydynamic_point'] !== NULL) ? "'{$data['storydynamic_point']}'" : 'NULL') . ', `storydynamic_value`=' . (($data['storydynamic_value'] !== '' && $data['storydynamic_value'] !== NULL) ? "'{$data['storydynamic_value']}'" : 'NULL') . ', `author_note`=' . (($data['author_note'] !== '' && $data['author_note'] !== NULL) ? "'{$data['author_note']}'" : 'NULL') . ', `director_note`=' . (($data['director_note'] !== '' && $data['director_note'] !== NULL) ? "'{$data['director_note']}'" : 'NULL') . ', `editor_note`=' . (($data['editor_note'] !== '' && $data['editor_note'] !== NULL) ? "'{$data['editor_note']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function storylines_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	// child table: storyboard
	$res = sql("select `id` from `storylines` where `id`='$selected_id'", $eo);
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `storyboard` where `scene`='".addslashes($id[0])."'", $eo);
	$rirow = db_fetch_row($rires);
	if($rirow[0] && !$AllowDeleteOfParents && !$skipChecks){
		$RetMsg = $Translation["couldn't delete"];
		$RetMsg = str_replace("<RelatedRecords>", $rirow[0], $RetMsg);
		$RetMsg = str_replace("<TableName>", "storyboard", $RetMsg);
		return $RetMsg;
	}elseif($rirow[0] && $AllowDeleteOfParents && !$skipChecks){
		$RetMsg = $Translation["confirm delete"];
		$RetMsg = str_replace("<RelatedRecords>", $rirow[0], $RetMsg);
		$RetMsg = str_replace("<TableName>", "storyboard", $RetMsg);
		$RetMsg = str_replace("<Delete>", "<input type=\"button\" class=\"button\" value=\"".$Translation['yes']."\" onClick=\"window.location='storylines_view.php?SelectedID=".urlencode($selected_id)."&delete_x=1&confirmed=1';\">", $RetMsg);
		$RetMsg = str_replace("<Cancel>", "<input type=\"button\" class=\"button\" value=\"".$Translation['no']."\" onClick=\"window.location='storylines_view.php?SelectedID=".urlencode($selected_id)."';\">", $RetMsg);
		return $RetMsg;
	}
...
function storylines_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `storylines` set       `story`=' . (($data['story'] !== '' && $data['story'] !== NULL) ? "'{$data['story']}'" : 'NULL') . ', `story_act`=' . (($data['story_act'] !== '' && $data['story_act'] !== NULL) ? "'{$data['story_act']}'" : 'NULL') . ', `storyweaving_scene_no`=' . (($data['storyweaving_scene_no'] !== '' && $data['storyweaving_scene_no'] !== NULL) ? "'{$data['storyweaving_scene_no']}'" : 'NULL') . ', `storyweaving_scene`=' . (($data['storyweaving_scene'] !== '' && $data['storyweaving_scene'] !== NULL) ? "'{$data['storyweaving_scene']}'" : 'NULL') . ', `storyweaving_sequence`=' . (($data['storyweaving_sequence'] !== '' && $data['storyweaving_sequence'] !== NULL) ? "'{$data['storyweaving_sequence']}'" : 'NULL') . ', `storyweaving_theme`=' . (($data['storyweaving_theme'] !== '' && $data['storyweaving_theme'] !== NULL) ? "'{$data['storyweaving_theme']}'" : 'NULL') . ', `role`=' . (($data['role'] !== '' && $data['role'] !== NULL) ? "'{$data['role']}'" : 'NULL') . ', `character`=' . (($data['character'] !== '' && $data['character'] !== NULL) ? "'{$data['character']}'" : 'NULL') . ', `characterevent_scene`=' . (($data['characterevent_scene'] !== '' && $data['characterevent_scene'] !== NULL) ? "'{$data['characterevent_scene']}'" : 'NULL') . ', `character_event`=' . (($data['character_event'] !== '' && $data['character_event'] !== NULL) ? "'{$data['character_event']}'" : 'NULL') . ', `storyline_no`=' . (($data['storyline_no'] !== '' && $data['storyline_no'] !== NULL) ? "'{$data['storyline_no']}'" : 'NULL') . ', `storyline`=' . (($data['storyline'] !== '' && $data['storyline'] !== NULL) ? "'{$data['storyline']}'" : 'NULL') . ', `story_appreciation`=' . (($data['story_appreciation'] !== '' && $data['story_appreciation'] !== NULL) ? "'{$data['story_appreciation']}'" : 'NULL') . ', `story_appreciation_value`=' . (($data['story_appreciation_value'] !== '' && $data['story_appreciation_value'] !== NULL) ? "'{$data['story_appreciation_value']}'" : 'NULL') . ', `effect_character`=' . (($data['effect_character'] !== '' && $data['effect_character'] !== NULL) ? "'{$data['effect_character']}'" : 'NULL') . ', `effect_plot`=' . (($data['effect_plot'] !== '' && $data['effect_plot'] !== NULL) ? "'{$data['effect_plot']}'" : 'NULL') . ', `effect_theme`=' . (($data['effect_theme'] !== '' && $data['effect_theme'] !== NULL) ? "'{$data['effect_theme']}'" : 'NULL') . ', `storydynamic_point`=' . (($data['storydynamic_point'] !== '' && $data['storydynamic_point'] !== NULL) ? "'{$data['storydynamic_point']}'" : 'NULL') . ', `storydynamic_value`=' . (($data['storydynamic_value'] !== '' && $data['storydynamic_value'] !== NULL) ? "'{$data['storydynamic_value']}'" : 'NULL') . ', `author_note`=' . (($data['author_note'] !== '' && $data['author_note'] !== NULL) ? "'{$data['author_note']}'" : 'NULL') . ', `director_note`=' . (($data['director_note'] !== '' && $data['director_note'] !== NULL) ? "'{$data['director_note']}'" : 'NULL') . ', `editor_note`=' . (($data['editor_note'] !== '' && $data['editor_note'] !== NULL) ? "'{$data['editor_note']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function storylines_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	$combo_storyweaving_scene_no->HTML = '<span id="storyweaving_scene_no-container' . $rnd1 . '"></span><input type="hidden" name="storyweaving_scene_no" id="storyweaving_scene_no' . $rnd1 . '" value="' . htmlspecialchars($combo_storyweaving_scene_no->SelectedData) . '">';
	$combo_storyweaving_scene_no->MatchText = '<span id="storyweaving_scene_no-container-readonly' . $rnd1 . '"></span><input type="hidden" name="storyweaving_scene_no" id="storyweaving_scene_no' . $rnd1 . '" value="' . htmlspecialchars($combo_storyweaving_scene_no->SelectedData) . '">';
	$combo_role->HTML = '<span id="role-container' . $rnd1 . '"></span><input type="hidden" name="role" id="role' . $rnd1 . '" value="' . htmlspecialchars($combo_role->SelectedData) . '">';
	$combo_role->MatchText = '<span id="role-container-readonly' . $rnd1 . '"></span><input type="hidden" name="role" id="role' . $rnd1 . '" value="' . htmlspecialchars($combo_role->SelectedData) . '">';
	$combo_character->HTML = '<span id="character-container' . $rnd1 . '"></span><input type="hidden" name="character" id="character' . $rnd1 . '" value="' . htmlspecialchars($combo_character->SelectedData) . '">';
	$combo_character->MatchText = '<span id="character-container-readonly' . $rnd1 . '"></span><input type="hidden" name="character" id="character' . $rnd1 . '" value="' . htmlspecialchars($combo_character->SelectedData) . '">';
	$combo_characterevent_scene->HTML = '<span id="characterevent_scene-container' . $rnd1 . '"></span><input type="hidden" name="characterevent_scene" id="characterevent_scene' . $rnd1 . '" value="' . htmlspecialchars($combo_characterevent_scene->SelectedData) . '">';
	$combo_characterevent_scene->MatchText = '<span id="characterevent_scene-container-readonly' . $rnd1 . '"></span><input type="hidden" name="characterevent_scene" id="characterevent_scene' . $rnd1 . '" value="' . htmlspecialchars($combo_characterevent_scene->SelectedData) . '">';
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#story_act').replaceWith('<div class=\"form-control-static\" id=\"story_act\">' + (jQuery('#story_act').val() || '') + '</div>'); jQuery('#story_act-multi-selection-help').hide();\n";
		...
		$jsReadOnly .= "\tjQuery('#story_appreciation').replaceWith('<div class=\"form-control-static\" id=\"story_appreciation\">' + (jQuery('#story_appreciation').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#story_appreciation_value').replaceWith('<div class=\"form-control-static\" id=\"story_appreciation_value\">' + (jQuery('#story_appreciation_value').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#effect_character').replaceWith('<div class=\"form-control-static\" id=\"effect_character\">' + (jQuery('#effect_character').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#effect_plot').replaceWith('<div class=\"form-control-static\" id=\"effect_plot\">' + (jQuery('#effect_plot').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#effect_theme').replaceWith('<div class=\"form-control-static\" id=\"effect_theme\">' + (jQuery('#effect_theme').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#storydynamic_point').replaceWith('<div class=\"form-control-static\" id=\"storydynamic_point\">' + (jQuery('#storydynamic_point').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#storydynamic_value').replaceWith('<div class=\"form-control-static\" id=\"storydynamic_value\">' + (jQuery('#storydynamic_value').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#author_note').replaceWith('<div class=\"form-control-static\" id=\"author_note\">' + (jQuery('#author_note').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#director_note').replaceWith('<div class=\"form-control-static\" id=\"director_note\">' + (jQuery('#director_note').val() || '') + '</div>');\n";
		$jsReadOnly .= "\tjQuery('#editor_note').replaceWith('<div class=\"form-control-static\" id=\"editor_note\">' + (jQuery('#editor_note').val() || '') + '</div>');\n";
	...
	$parent_tables = array(  'story' => array('story', 'Story'), 'storyweaving_scenes' => array('storyweaving_scene_no', 'Storyweaving scene no.'), 'class_dramatica_archetype' => array('role', 'Role'), 'story_characters' => array('character', 'Character'), 'code_encounters' => array('characterevent_scene', 'Encounter'));
	...
	$templateCode=str_replace('<%%UPLOADFILE(story_appreciation)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(story_appreciation_value)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(effect_character)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(effect_plot)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(effect_theme)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(storydynamic_point)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(storydynamic_value)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(author_note)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(director_note)%%>', '', $templateCode);
	$templateCode=str_replace('<%%UPLOADFILE(editor_note)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		$templateCode=str_replace('<%%VALUE(story_appreciation)%%>', htmlspecialchars($row['story_appreciation'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(story_appreciation)%%>', urlencode($urow['story_appreciation']), $templateCode);
		$templateCode=str_replace('<%%VALUE(story_appreciation_value)%%>', htmlspecialchars($row['story_appreciation_value'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(story_appreciation_value)%%>', urlencode($urow['story_appreciation_value']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(effect_character)%%>', nl2br(htmlspecialchars($row['effect_character'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(effect_character)%%>', htmlspecialchars($row['effect_character'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(effect_character)%%>', urlencode($urow['effect_character']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(effect_plot)%%>', nl2br(htmlspecialchars($row['effect_plot'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(effect_plot)%%>', htmlspecialchars($row['effect_plot'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(effect_plot)%%>', urlencode($urow['effect_plot']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(effect_theme)%%>', nl2br(htmlspecialchars($row['effect_theme'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(effect_theme)%%>', htmlspecialchars($row['effect_theme'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(effect_theme)%%>', urlencode($urow['effect_theme']), $templateCode);
		$templateCode=str_replace('<%%VALUE(storydynamic_point)%%>', htmlspecialchars($row['storydynamic_point'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(storydynamic_point)%%>', urlencode($urow['storydynamic_point']), $templateCode);
		$templateCode=str_replace('<%%VALUE(storydynamic_value)%%>', htmlspecialchars($row['storydynamic_value'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(storydynamic_value)%%>', urlencode($urow['storydynamic_value']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(author_note)%%>', nl2br(htmlspecialchars($row['author_note'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(author_note)%%>', htmlspecialchars($row['author_note'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(author_note)%%>', urlencode($urow['author_note']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(director_note)%%>', nl2br(htmlspecialchars($row['director_note'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(director_note)%%>', htmlspecialchars($row['director_note'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(director_note)%%>', urlencode($urow['director_note']), $templateCode);
		if($dvprint){
			$templateCode = str_replace('<%%VALUE(editor_note)%%>', nl2br(htmlspecialchars($row['editor_note'], ENT_QUOTES)), $templateCode);
		}else{
			$templateCode = str_replace('<%%VALUE(editor_note)%%>', htmlspecialchars($row['editor_note'], ENT_QUOTES), $templateCode);
		}
		$templateCode=str_replace('<%%URLVALUE(editor_note)%%>', urlencode($urow['editor_note']), $templateCode);
	}else{
		...
		$templateCode=str_replace('<%%VALUE(story_appreciation)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(story_appreciation)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(story_appreciation_value)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(story_appreciation_value)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(effect_character)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(effect_character)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(effect_plot)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(effect_plot)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(effect_theme)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(effect_theme)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(storydynamic_point)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(storydynamic_point)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(storydynamic_value)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(storydynamic_value)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(author_note)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(author_note)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(director_note)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(director_note)%%>', urlencode(''), $templateCode);
		$templateCode=str_replace('<%%VALUE(editor_note)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(editor_note)%%>', urlencode(''), $templateCode);
	}
