...
<?php $current_table = 'biblio_trascript'; ?>
<script>
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][7]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[7]){ ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=transcript&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[7]); ?>"><i class="glyphicon glyphicon-file text-info"></i></a><?php } ?></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[8]){ ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=credits&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[8]); ?>"><i class="glyphicon glyphicon-file text-info"></i></a><?php } ?></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
